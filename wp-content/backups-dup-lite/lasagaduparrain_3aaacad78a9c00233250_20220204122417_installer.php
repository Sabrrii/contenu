...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'lasagaduparrain_3aaacad78a9c00233250_20220204122417_archive.zip';
	const ARCHIVE_SIZE		 = '38682641';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3aaacad-04122417';
    const SECONDARY_PACKAGE_HASH = '82016eb-04122417';
	const VERSION			 = '1.4.4';
